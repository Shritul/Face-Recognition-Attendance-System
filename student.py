...
class Student:
    def __init__(self, root):
        ...
        #image
        img1=Image.open(r"images\facialrecognition.jpg") 
        img1=img1.resize((1600, 130), Image.ANTIALIAS) 
        ...
        title_lbl=Label(bg_img, text="STUDENT MANAGEMENT SYSYTEM", font=("times new roman", 35, "bold"), bg="#7FB5FF", fg="black") 
        ...
        img_left=Image.open(r"images\student_details2.png") 
        ...
        #department
        dept_lbl=Label(current_course_frame, text="Department", font=("times new roman", 13, "bold"), bg="white")
        dept_lbl.grid(row=0, column=0, padx=10, sticky=W)

        dept_combo=ttk.Combobox(current_course_frame, textvariable=self.var_dept, font=("times new roman", 13, "bold"), width=20, state="readonly")
        ...
        #student id
        studentId_lbl=Label(class_student_frame, text="StudentID:", font=("times new roman", 13, "bold"), bg="white")
        ...
        #teacher name
        teacher_lbl=Label(class_student_frame, text="Teacher Name:", font=("times new roman", 13, "bold"), bg="white")
        ...
        save_btn=Button(btn_frame, text="Save", command=self.add_data, width=17, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        save_btn.grid(row=0, column=0)

        update_btn=Button(btn_frame, text="Update", command=self.update_data, width=17, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        update_btn.grid(row=0, column=1)

        dlt_btn=Button(btn_frame, text="Delete", command=self.delete_data, width=17, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        dlt_btn.grid(row=0, column=2)

        reset_btn=Button(btn_frame, text="Reset", command=self.reset_data, width=17, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        reset_btn.grid(row=0, column=3)

        btn_frame1=Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame1.place(x=0, y=235, width=715, height=35)

        take_photo_btn=Button(btn_frame1, text="Take Photo Sample", command=self.generate_dataset, width=35, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn=Button(btn_frame1, text="Update Photo Sample", command=self.generate_dataset, width=35, font=("times new roman", 13, "bold"), bg="#001D6E", fg="white")
        ...
        img_right=Image.open(r"images\student_details.png") 
        ...
        table_frame.place(x=5, y=135, width=710, height=410)
    ...
    def add_data(self):
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost", user="root", password="Ganeshaya#20", database="face_recognizer")
    ...
    def generate_dataset(self):
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #     face=cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)
                #     file_name_path="data/user."+str(i)+"."+str(img_id)+".jpg"
                #     while os.path.isfile(file_name_path):
                #         i+=1
                #         file_name_path="data/user."+str(i)+"."+str(img_id)+".jpg"
