...
class Attendance:
    def __init__(self, root): 
        ...
        f_lbl.place(x=15, y=0, width=1500, height=200)

        #bg image
        img3=Image.open(r"images\bg_img.png")
        ...
        title_lbl=Label(bg_img, text="ATTENDANCE MANAGEMENT SYSYTEM", font=("times new roman", 35, "bold"), bg="#7FB5FF", fg="black") 
        ...
        img_left=Image.open(r"images\student_details.png") 
        ...
        #roll
        roll_lbl=Label(left_inside_frame, text="Roll_No:", font=("comicsansns", 11, "bold"), bg="white")
        ...
        #name
        name_lbl=Label(left_inside_frame, text="Name:", font=("comicsansns", 11, "bold"), bg="white")
        ...
        #department
        dept_lbl=Label(left_inside_frame, text="Department:", font=("comicsansns", 11, "bold"), bg="white")
        dept_lbl.grid(row=1, column=2)

        atten_dept=ttk.Entry(left_inside_frame, width=22, textvariable=self.var_atten_dept, font=("comicsansns", 11, "bold"))
        atten_dept.grid(row=1, column=3, pady=8)

        #time
        time_lbl=Label(left_inside_frame, text="Time:", font=("comicsansns", 11, "bold"), bg="white")
        ...
        #date
        date_lbl=Label(left_inside_frame, text="Date:", font=("comicsansns", 11, "bold"), bg="white")
        ...
        #attendance
        attendance_lbl=Label(left_inside_frame, text="Attendance Status", font=("comicsansns", 11, "bold"), bg="white")
